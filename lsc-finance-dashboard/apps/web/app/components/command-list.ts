...
export const PALETTE_COMMANDS: PaletteCommand[] = [
  ...
  { id: "nav-tbr-operating-expenses", label: "TBR Operating Expenses", group: "TBR", href: "/tbr/operating-expenses", keywords: "season finance budget financial plan" },
  { id: "nav-tbr-e1-accounting", label: "TBR E1 Accounting", group: "TBR", href: "/tbr/e1-accounting", keywords: "e1 invoices payments accounting ledger" },
  { id: "nav-tbr-overall-pnl", label: "TBR Overall P&L", group: "TBR", href: "/tbr/overall-pnl", keywords: "profit loss pnl season ebitda" },
