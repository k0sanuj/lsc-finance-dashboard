...
export default async function PayrollInvoicesPage({ searchParams }: PageProps) {
  ...
  return (
    <div className="page-grid">
      ...
      <header className="workspace-header">
        <div className="workspace-header-left">
          ...
          <p className="muted">
            ...
            applied to INR salary lines; fixed USD salaries stay in USD. Terminated employees are excluded.
          </p>
        </div>
      ...
      <AIIntakeReviewPanel
        draftId={aiDraftId}
        redirectPath={`/payroll-invoices/generator?month=${selectedMonth}`}
        title="Review XTZ invoice support"
      />
      ...
      <section className="card">
        <div className="card-title-row">
          ...
          <MonthPicker value={selectedMonth} basePath="/payroll-invoices/generator" />
        </div>
      </section>

      <AIIntakePanel
        title="AI invoice item intake"
        description="Upload or paste vendor invoices, reimbursement support, payroll support, or provisional documents. AI extracts fields into a preview; finance approval posts the record into the invoice staging tables."
        companyCode="XTZ"
        redirectPath={`/payroll-invoices/generator?month=${selectedMonth}`}
        workflowContext={`xtz-invoice-generator:${selectedMonth}`}
        ...
        notePlaceholder="Add month, vendor/payee, section, and whether this should become software, reimbursement, payroll support, or provision staging."
      />
      ...
      <section className="card">
        ...
        <form action={addMdgFeeAction}>
          ...
          <input type="hidden" name="returnPath" value={`/payroll-invoices/generator?month=${selectedMonth}`} />
      ...
      <section className="card">
        ...
        <p className="muted" style={{ marginTop: 0 }}>
          Use the AI intake panel above for receipt extraction, preview, approval, and posting. Manual entry stays available for controlled corrections.
        </p>
